...
class TypeRefinement {
    ...
    // :: error: (polyall.h1invalid.forbidden) :.constructor.invocation: warning: (cast.unsafe)
    ...
    @H1Invalid Object getH1Invalid() {
        // :: error: (polyall.constructor.invocation.h1invalid.forbidden) :: warning: (cast.unsafe)
