...
public final class Objects {
     ...
     * @see Object#hashCode
     */
    public static @NonDet int hashCode(@PolyDet Object o) {
     ...
     * @see List#hashCode
     */
    public static @NonDet int hash(@PolyDet Object... values) {
     ...
     */
    public static <T> @PolyDet T requireNonNull(@PolyDet T obj) {
        if (obj == null)
     ...
     * @throws NullPointerException if {@code obj} is {@code null}
     */
    public static <T> T requireNonNull(@PolyDet T obj, @PolyDet String message) {
        if (obj == null)
     ...
     * @since 1.8
     */
    public static <T> T requireNonNull(@PolyDet T obj, @PolyDet Supplier<@PolyDet String> messageSupplier) {
        if (obj == null)
