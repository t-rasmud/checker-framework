...
final class DualPivotQuicksort {
     ...
     */
    static void sort(@PolyDet("use") int @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right,
     ...
     * @param workLen usable size of work array
     */
    static void sort(@PolyDet("use") long @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right,
     ...
     * @param leftmost indicates if this part is the leftmost in the range
     */
    private static void sort(@PolyDet("use") long @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right, @PolyDet("use") boolean leftmost) {
        int length = right - left + 1;
     ...
     * @param workLen usable size of work array
     */
    static void sort(@PolyDet("use") short @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right,
     ...
     * @param leftmost indicates if this part is the leftmost in the range
     */
    private static void sort(@PolyDet("use") short @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right, @PolyDet("use") boolean leftmost) {
        int length = right - left + 1;
     ...
     * @param workLen usable size of work array
     */
    static void sort(@PolyDet("use") char @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right,
     ...
     * @param leftmost indicates if this part is the leftmost in the range
     */
    private static void sort(@PolyDet("use") char @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right, @PolyDet("use") boolean leftmost) {
        int length = right - left + 1;
     ...
     * @param right the index of the last element, inclusive, to be sorted
     */
    static void sort(@PolyDet("use") byte @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right) {
        // Use counting sort on large arrays
     ...
     * @param workLen usable size of work array
     */
    static void sort(@PolyDet("use") float @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right,
     ...
     * @param leftmost indicates if this part is the leftmost in the range
     */
    private static void sort(@PolyDet("use") float @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right, @PolyDet("use") boolean leftmost) {
        int length = right - left + 1;
     ...
     * @param workLen usable size of work array
     */
    static void sort(@PolyDet("use") double @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right,
     ...
     * @param leftmost indicates if this part is the leftmost in the range
     */
    private static void sort(@PolyDet("use") double @PolyDet [] a, @PolyDet("use") int left, @PolyDet("use") int right, @PolyDet("use") boolean leftmost) {
        int length = right - left + 1;
