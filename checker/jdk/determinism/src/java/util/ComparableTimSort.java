...
class ComparableTimSort {
     ...
     * @since 1.8
     */
    static void sort(@PolyDet("use") Object @PolyDet [] a, @PolyDet("use") int lo, @PolyDet("use") int hi, @PolyDet("use") Object @PolyDet("use") [] work, @PolyDet("use") int workBase, @PolyDet("use") int workLen) {
