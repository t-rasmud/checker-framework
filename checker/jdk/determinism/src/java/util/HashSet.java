    ...
    implements Set<E>, Cloneable, java.io.Serializable
{
     ...
     */
    public @PolyDet("down") int size(@PolyDet HashSet<E> this) {
        return map.size();
    }
     ...
     */
    public @PolyDet("down") boolean isEmpty(@PolyDet HashSet<E> this) {
        return map.isEmpty();
    }
     ...
     */
    public @PolyDet("down") boolean contains(@PolyDet HashSet<E> this, @PolyDet Object o) {
    ...
    public @PolyDet("down") boolean add(@PolyDet HashSet<@PolyDet("use") E> this, @PolyDet("use") E e) {
     ...
     */
    @CheckReceiverForMutation
    public @PolyDet("down") boolean remove(@PolyDet HashSet<@PolyDet("use") E> this, @PolyDet("use") Object o) {
     ...
     */
    @CheckReceiverForMutation
    public void clear(@PolyDet HashSet<@PolyDet("use") E> this) {
        map.clear();
    }
     ...
     * @since 1.8
     */
    public @PolyDet Spliterator<E> spliterator(@PolyDet HashSet<E> this) {
