...
public abstract class AbstractMap<K,V> implements Map<K,V> {
     ...
     */
    public @NonDet int hashCode(@PolyDet AbstractMap<K,V> this) {
        int h = 0;
        Iterator<Entry<K,V>> i = entrySet().iterator();
        while (i.hasNext())
            h += i.next().hashCode();
            ...
            implements Entry<K,V>, java.io.Serializable
    {
         ...
         */
        public @PolyDet K getKey(@PolyDet SimpleEntry<K,V> this) {
            return key;
        }
         ...
         */
        public @PolyDet V getValue(@PolyDet SimpleEntry<K,V> this) {
            return value;
        }
         ...
         * @see    #equals
         */
        public @NonDet int hashCode(@PolyDet SimpleEntry<K,V> this) {
            ...
            implements Entry<K,V>, java.io.Serializable
    {
         ...
         * @return the key corresponding to this entry
         */
        public @PolyDet K getKey(@PolyDet SimpleImmutableEntry<K,V> this) {
            return key;
        }
         ...
         * @see    #equals
         */
        public @NonDet int hashCode(@PolyDet SimpleImmutableEntry<K,V> this) {
            return (key   == null ? 0 :   key.hashCode()) ^
                    (value == null ? 0 : value.hashCode());
        }
