...
public final class Longs {
     ...
     * to {@code ByteBuffer.allocate(8).putLong(value).array()}. For example, the input value {@code
     ...
     *
     * <p>Unlike {@link Long#parseLong(String)}, this method returns {@code null} instead of
     ...
     * compares, using {@link #compare(long, long)}), the first pair of values that follow any
