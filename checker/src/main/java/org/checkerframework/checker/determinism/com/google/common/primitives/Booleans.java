...
public final class Booleans {
     ...
     * concat(new boolean[] {a, b}, new boolean[] {}, new boolean[] {c}} returns the array {@code
     * {a, b, c}}.
     *
    ...
    /**
     * Returns a string containing the supplied {@code boolean} values separated by {@code
     * separator}. For example, {@code join("-", false, true, false)} returns the string {@code
     * "false-true-false"}.
     *
    ...
    /**
     * Copies a collection of {@code Boolean} instances into a new array of primitive {@code
     * boolean} values.
     *
