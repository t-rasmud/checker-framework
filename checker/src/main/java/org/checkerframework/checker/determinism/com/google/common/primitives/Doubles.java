...
public final class Doubles {
     ...
     * concat(new double[] {a, b}, new double[] {}, new double[] {c}} returns the array {@code {a,
     * b, c}}.
     *
     ...
     *
     * <p>The returned list may have unexpected behavior if it contains {@code NaN}, or if {@code
     ...
     *
     * <p>This implementation is likely to be faster than {@code Double.parseDouble} if many
