...
public class NonEmptyTransfer
  ...
  public TransferResult<NonEmptyValue, NonEmptyStore> visitGreaterThan(
      GreaterThanNode n, TransferInput<NonEmptyValue, NonEmptyStore> cfValueCFStoreTransferInput) {
  ...
  /**
   * For a conditional that checks {@code Collection.size() >= x} where {@code x >= 1}, refines the
   * type of the {@code Collection} to {@code @NonEmpty} in the then branch.
   *
  ...
  public TransferResult<NonEmptyValue, NonEmptyStore> visitLessThan(
      LessThanNode n, TransferInput<NonEmptyValue, NonEmptyStore> cfValueCFStoreTransferInput) {
    TransferResult<NonEmptyValue, NonEmptyStore> resultIn =
  ...
  /**
   * For a conditional that checks {@code Collection.size() <= x} where {@code x <= 1}, refines the
   * type of the {@code Collection} to {@code @NonEmpty} in the else branch. This is an
   ...
   * Collection.size(), refines the type of the {@code Collection} to {@code @NonEmpty} in the else
   * branch.
   *
   * @param n EqualToNode
