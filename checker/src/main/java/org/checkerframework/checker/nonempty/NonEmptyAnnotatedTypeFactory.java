...
/**
 * Defines type hierarchy of the NonEmpty Checker qualifiers. This is necessary for Checkers like
 * the Iteration Checker that use the NonEmpty Checker as a subchecker.
 */
public class NonEmptyAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
    ...
    public final AnnotationMirror NONEMPTY = AnnotationBuilder.fromClass(elements, NonEmpty.class);
