...
public class FloatingDivisionNode extends BinaryOperationNode {
    ...
    @Override
    public @PolyDet String toString(@PolyDet FloatingDivisionNode this) {
        return "(" + getLeftOperand() + " / " + getRightOperand() + ")";
    }

    @Override
    public @PolyDet boolean equals(
            @PolyDet FloatingDivisionNode this, @PolyDet @Nullable Object obj) {
    ...
    @Override
    public @PolyDet int hashCode(@PolyDet FloatingDivisionNode this) {
