...
public class GreaterThanOrEqualNode extends BinaryOperationNode {
    ...
    @Override
    public @PolyDet String toString(@PolyDet GreaterThanOrEqualNode this) {
        return "(" + getLeftOperand() + " >= " + getRightOperand() + ")";
    }

    @Override
    public @PolyDet boolean equals(
            @PolyDet GreaterThanOrEqualNode this, @PolyDet @Nullable Object obj) {
    ...
    @Override
    public @PolyDet int hashCode(@PolyDet GreaterThanOrEqualNode this) {
