...
public class CFGTranslationPhaseOne extends TreePathScanner<Node, Void> {
     ...
     */
    @OrderNonDet Map<Name, Label> breakLabels;
     ...
     */
    @OrderNonDet Map<Name, Label> continueLabels;
    ...
    protected NodeWithExceptionsHolder extendWithNodeWithExceptions(
        ...
        addToLookupMap(node);
        Map<@Det TypeMirror, @Det Set<Label>> exceptions = new @OrderNonDet LinkedHashMap<>();
    ...
    public Node visitTry(TryTree tree, Void p) {
        ...
        if (finallyLabel != null) {
            ...
            if (!accessedBreakLabels.isEmpty()) {
                ...
                for (Map.Entry<Name, Label> tmpAccess : accessedBreakLabels.entrySet()) {
                    Map.@Det Entry<Name, Label> access = tmpAccess;
