...
\item \ahrefloc{nonempty-checker}{NonEmpty Checker} to ensure that a Collection, Map, or an Iterator contains atleast one element. (see \chapterpageref{nonempty-checker})\item
