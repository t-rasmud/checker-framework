...
\item
  \ahrefloc{iteration-checker}{Iteration Checker} to ensure that \code{Iterator.next()} does not throw NoSuchElementException
  (see \chapterpageref{iteration-checker})
\item
