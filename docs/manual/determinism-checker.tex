...
% Implementation bug: @RequiresDetToString incorrectly uses 0-based indexing for formal parameters.
% As a result, the programmer cannot specify that the receiver must have deterministic toString()
% https://github.com/t-rasmud/checker-framework/issues/224
A user can also specify which specific arguments must have deterministic \<toString> by
