...
At method signatures, \<@PolyDet("use")> gets replaced by the type qualifier that \<@PolyDet>
resolves to. As a result, one could imagine a qualifier hierarchy without \<@PolyDet("use")>
