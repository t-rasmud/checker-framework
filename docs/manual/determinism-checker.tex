...
When an array of type \<@OrderNonDet> (or \<@PolyDet>) is accessed, we
annotate the type of the array access expression (equivalently, the array element) as
...
replaced the type of every \<@OrderNonDet> array access with
