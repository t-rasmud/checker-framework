...
-AuseDefault=PolyDet, then the following types default to \<@PolyDet>:
\begin{itemize}
...
\end{itemize}
If the command line option -AuseDefault is not supplied (or is supplied with
a value other than PolyDet), the above types default to \<@Det>.
