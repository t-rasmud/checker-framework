...
\begin{Verbatim}
void set(@PolyDet List<E> this, @PolyDet("up") int index);
\end{Verbatim}

Only the following calls are legal:

\begin{Verbatim}
set(@NonDet List<E> , @NonDet int);
set(@NonDet List<E> , @Det int);
set(@OrderNonDet List<E> , @NonDet int);
set(@OrderNonDet List<E> , @Det int);
set(@Det List<E> , @Det int);
\end{Verbatim}
...
\begin{Verbatim}
void remove(@PolyDet("noOrderNonDet") List<E> this);
\end{Verbatim}

allows the following calls:

\begin{Verbatim}
remove(@NonDet List<E>);
remove(@Det List<E>);
\end{Verbatim}

The call \code{remove(@OrderNonDet List<E>);} is illegal.
