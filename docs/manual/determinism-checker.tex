...
\begin{figure}
    \begin{center}
        \includeimage{poly-hierarchy}{6cm}
    \end{center}
    \caption{\<@PolyDet> type hierarchy}
    \label{fig-poly-hierarchy}
\end{figure}
Figure~\ref{fig-poly-hierarchy} shows the type qualifier hierarchy among all the
...
could be \code{m(@Det ..., @NonDet ...)}. To avoid this unsoundness, the determimisn checker
