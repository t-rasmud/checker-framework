...
As alluded to earlier, we allow \<@PolyDet("use")> to resolve to any
type qualifier as long as it is a subtype of the qualifier
that \<@PolyDet> resolves to. To illustrate why the subtyping relationship helps precision,
